        ...
        <div className='flex items-center justify-between w-full '>
          ...
          <div className='w-1/2 flex flex-col items-center self-center'>
            ...
            <div className='flex items-center self-start mt-2'>
              ...
              <Link href="mailto:contact.rootedtogether@gmail.com" className='flex items-center ml-4 p-2.5 px-6 rounded-lg text-lg font-semibold  text-dark border-2 border-solid border-transparent border-dark hover:text-light hover:bg-dark' >Contact</Link>
            </div>
          </div>
        </div>
      </div>
